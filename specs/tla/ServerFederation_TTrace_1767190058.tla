---- MODULE ServerFederation_TTrace_1767190058 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ServerFederation_TTrace_1767190058.json", _TETrace)
...
\*
\*trace == IODeserialize("ServerFederation_TTrace_1767190058.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "DEGRADED" @@ backup :> "HEALTHY" @@ contributor1 :> "UNKNOWN"),failureCount |-> (hetzner :> 1 @@ backup :> 0 @@ contributor1 :> 0)])
    >>
----
...
---- CONFIG ServerFederation_TTrace_1767190058 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Dec 31 15:07:38 CET 2025