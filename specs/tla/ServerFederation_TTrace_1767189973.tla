---- MODULE ServerFederation_TTrace_1767189973 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ServerFederation_TTrace_1767189973.json", _TETrace)
...
\*
\*trace == IODeserialize("ServerFederation_TTrace_1767189973.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ServerFederation_TTrace_1767189973 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Dec 31 15:06:14 CET 2025