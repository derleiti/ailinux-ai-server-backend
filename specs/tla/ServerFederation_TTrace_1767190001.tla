---- MODULE ServerFederation_TTrace_1767190001 ----
...
_inv ==
    ~(
        ...
        time = (0)
        /\
        nodeStatus = ((hetzner :> "DEGRADED" @@ backup :> "DEGRADED" @@ contributor1 :> "DEGRADED"))
        /\
        failureCount = ((hetzner :> 2 @@ backup :> 1 @@ contributor1 :> 1))
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ServerFederation_TTrace_1767190001.json", _TETrace)
...
\*
\*trace == IODeserialize("ServerFederation_TTrace_1767190001.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "DEGRADED" @@ backup :> "UNKNOWN" @@ contributor1 :> "UNKNOWN"),failureCount |-> (hetzner :> 1 @@ backup :> 0 @@ contributor1 :> 0)]),
    ...
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "DEGRADED" @@ backup :> "DEGRADED" @@ contributor1 :> "DEGRADED"),failureCount |-> (hetzner :> 2 @@ backup :> 1 @@ contributor1 :> 1)])
    >>
----
...
---- CONFIG ServerFederation_TTrace_1767190001 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Dec 31 15:06:42 CET 2025