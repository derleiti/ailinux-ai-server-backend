---- MODULE ServerFederation_TTrace_1767190081 ----
...
_inv ==
    ~(
        ...
        time = (0)
        /\
        nodeStatus = ((hetzner :> "DEGRADED" @@ backup :> "UNKNOWN" @@ contributor1 :> "HEALTHY"))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ServerFederation_TTrace_1767190081.json", _TETrace)
...
\*
\*trace == IODeserialize("ServerFederation_TTrace_1767190081.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "HEALTHY" @@ backup :> "UNKNOWN" @@ contributor1 :> "HEALTHY"),failureCount |-> (hetzner :> 0 @@ backup :> 0 @@ contributor1 :> 0)]),
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "DEGRADED" @@ backup :> "UNKNOWN" @@ contributor1 :> "HEALTHY"),failureCount |-> (hetzner :> 1 @@ backup :> 0 @@ contributor1 :> 0)])
    >>
----
...
---- CONFIG ServerFederation_TTrace_1767190081 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Dec 31 15:08:02 CET 2025