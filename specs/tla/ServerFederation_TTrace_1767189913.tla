---- MODULE ServerFederation_TTrace_1767189913 ----
...
_inv ==
    ~(
        ...
        time = (0)
        /\
        nodeStatus = ((hetzner :> "DEGRADED" @@ backup :> "UNKNOWN" @@ contributor1 :> "UNKNOWN"))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ServerFederation_TTrace_1767189913.json", _TETrace)
...
\*
\*trace == IODeserialize("ServerFederation_TTrace_1767189913.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ServerFederation_TTrace_1767189913 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Dec 31 15:05:13 CET 2025