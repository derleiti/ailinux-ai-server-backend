---- MODULE ServerFederation_TTrace_1767189941 ----
...
_inv ==
    ~(
        ...
        time = (0)
        /\
        nodeStatus = ((hetzner :> "OFFLINE" @@ backup :> "UNKNOWN" @@ contributor1 :> "UNKNOWN"))
        /\
        failureCount = ((hetzner :> 3 @@ backup :> 0 @@ contributor1 :> 0))
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ServerFederation_TTrace_1767189941.json", _TETrace)
...
\*
\*trace == IODeserialize("ServerFederation_TTrace_1767189941.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "DEGRADED" @@ backup :> "UNKNOWN" @@ contributor1 :> "UNKNOWN"),failureCount |-> (hetzner :> 2 @@ backup :> 0 @@ contributor1 :> 0)]),
    ([primaryNode |-> hetzner,time |-> 0,nodeStatus |-> (hetzner :> "OFFLINE" @@ backup :> "UNKNOWN" @@ contributor1 :> "UNKNOWN"),failureCount |-> (hetzner :> 3 @@ backup :> 0 @@ contributor1 :> 0)])
    >>
----
...
---- CONFIG ServerFederation_TTrace_1767189941 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Dec 31 15:05:41 CET 2025